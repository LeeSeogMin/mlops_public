#!/usr/bin/env python3
"""12주차 공정성·설명가능성 실습 오케스트레이션: 그룹 편향·설명·모델카드·루브릭 생성 + PASS 게이트.
...
CODE = BASE_DIR / "code" / "12-2-fairness-xai.py"
...
def main() -> int:
    ...
    print("CH12_FAIRNESS_RUN_PASS" if not failures else f"CH12_FAIRNESS_RUN_FAIL({'; '.join(failures)})")
