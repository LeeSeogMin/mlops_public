...
증거 산출물: data/output/ch7_batch_run_report.json
"""
...
DAG_FILE = BASE_DIR / "code" / "7-1-daily-report-dag.py"
...
def load_module():
    spec = importlib.util.spec_from_file_location("ch7_daily_report_dag", DAG_FILE)
...
def main() -> int:
    ...
    # ── 증거 저장 + 종합 판정 ──
    evidence = OUTPUT_DIR / "ch7_batch_run_report.json"
    evidence.write_text(
