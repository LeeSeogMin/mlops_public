...
- **제출물**: 매주 실습 결과 파일 + 관찰 보고서 (1페이지 이내)
- **마감**: 수업일 포함 7일 이내
- **평가**: 실행 결과 정상 생성(50%) + 관찰 보고서 논리적 서술(50%)

### 평가 방법

| 항목 | 비율 | 내용 |
|------|------|------|
| 중간고사 | 25% | 1-7주차 범위 (Part 1-2) |
| 기말고사 | 25% | 9-14주차 범위 (Part 3-4) |
| 실습 과제 | 40% | 매주 구글 클래스룸 제출 (결과 파일 + 관찰 보고서) |
| 수업 참여 | 10% | 온라인 토론 참여, 체크 질문 응답 |
